function validateEditHoldingsForm(){
	//var holdingName = document.forms["editHoldingsForm"]["addHoldingsName"].value;
		//if(holdingName == null || holdingName == ""){
			//alert("Search for a company. Symbol/Name field must be filled out");
			//return false;
		//}
	var tradingDate = document.forms["editHoldingsForm"]["editHoldingsDate"].value;
		if(tradingDate == null || tradingDate == ""){
			alert("Select the day you purchased your shares");
			return false;
		}
	var numberOfShares = document.forms["editHoldingsForm"]["editHoldingsDate"].value;
	...
	var price = document.forms["editHoldingsForm"]["editHoldingsDate"].value;
		if(price == null || price == ""){
