...
<head>
	...
	<title id="stockTitleName"></title> <!-- to get the stock data from yahoo -->
	<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.4.1/jquery.min.js"></script>	<!--JQuery AJAX library-->
	<script src="../../js/individualStockData.js"></script> <!-- to get the stock data from yahoo -->
...
<body onload="start()">
	<div class="header"> <!--navigation bar -->
		<span class="home">
			...
			<form action="" class="search"> <!--search for a company -->
...
<hr id="footerLine">
<div><?php require("../../php/footer.php"); ?></div> <!--footer -->
<script>
var BASE_URL = 'https://query.yahooapis.com/v1/public/yql?q=';
var yql_query = 'select * from yahoo.finance.quotes where symbol in ("MSFT")';
</script>
<script>
