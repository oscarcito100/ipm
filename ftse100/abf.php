...
<head>
	...
	<script src="../../js/ukStockData.js"></script> <!-- File to get all the data of a bristish companies, i can use it for all stock in euros-->
...
var yql_query = 'select * from yahoo.finance.quotes where symbol in ("ABF.L")';
</script>
<script>
