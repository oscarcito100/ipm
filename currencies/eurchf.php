...
<head>
	...
	<title id="currencyTitleName"></title>
	<!--JQuery AJAX library-->
	<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.4.1/jquery.min.js"></script>
	<script src="../../js/exchangeRateData.js"></script> <!-- get exchange rate data form yahoo-->
...
<body onload="start()">
	...
	<div class="titlePage">	
		<span class="mainTitle" id="currencyName"></span>
		<span class="subTitle">MAJOR CURRENCIES</span>
	</div>
	<hr class="titleLine">
...
var yql_query = 'select * from yahoo.finance.xchange where pair in ("EURCHF")';
</script>
<script>
