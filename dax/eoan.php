...
<head>
	...
	<script src="../../js/germanStockData.js"></script> <!-- File to get all the data of a german company, i can use it for all stock in euros-->
...
<body onload="start()">
	...
	<div class="titlePage">	<!-- title of the content of the page-->
		...
		<span class="subTitle">GERMAN STOCKS</span>
	</div>
	<hr class="titleLine">
...
var yql_query = 'select * from yahoo.finance.quotes where symbol in ("EOAN.DE")';
</script>
<script>
